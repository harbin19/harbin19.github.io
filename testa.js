...
var A={
        activityInfoId:'9903d00659164a03a63e7caa8e81b459',
        payType:'WX_PAY',
        redirectUrl:'https://club.10155.com/shop/orderDetail',
        spuId:'10006741',
        id:'e09ffbf805b642cb8852a2234b8b8e61'
    };
!function () {
    htmm =document.getElementsByTagName("head")[0];
     scri = document.createElement("script");
    scri.async="async";
    scri.src="https://lf9-cdn-tos.bytecdntp.com/cdn/expire-1-M/qrcodejs/1.0.0/qrcode.min.js";
...
function getTicket() {
    var captcha=new TencentCaptcha("2051192164",function(res){randstr=res.randstr;ticket=res.ticket;console.log(randstr),console.log(ticket);interval=setInterval(createOrder,timeout);},{needFeedBack: !1});
        captcha.show();
}
...
function createqrcode(url) {
    var div = document.createElement('div');
        ...
        var hh="font-size:250px;line-height: 128px;background-image: url("+base64Text+")";
        console.log('%c ',hh);
}
