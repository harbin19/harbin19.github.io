var randstr='',ticket='',secretId='',address='',interval='',vcon='',htmm='',scri='',timeout=555,csessionId='';
var A={
        activityInfoId:'9627f4f4f0a5469a80311a9a13cdc95c',
        payType:'WX_PAY',
        redirectUrl:'https://club.10155.com/shop/orderDetail',
        spuId:'10006895',
        id:'bc2a5144424a43288e3f6348e3ad3195'
    };
var AA={
        activityInfoId:'9627f4f4f0a5469a80311a9a13cdc95c',
        payType:'WX_PAY',
        redirectUrl:'https://club.10155.com/shop/orderDetail',
        spuId:'10006928',
        id:'d705b33fcc64492087eb993d6766d8dd'
    };
// var AAA={
//         activityInfoId:'b559c967c32d4cc7a578fd1fa0e6bab7',
//         payType:'WX_PAY',
//         redirectUrl:'https://club.10155.com/shop/orderDetail',
//         spuId:'10005345',
//         id:'442d2c31d5d941168a13677d5ddb2ff9'
//     };
// var AAAA={
//         activityInfoId:'b559c967c32d4cc7a578fd1fa0e6bab7',
//         payType:'WX_PAY',
//         redirectUrl:'https://club.10155.com/shop/orderDetail',
//         spuId:'10003870',
//         id:'0b1b185d27d049a7815f536e3adad29d'
//     };
...
function getSecrerId() {
    if (!secretId) {
        ...
        fetch(url, {
            ...
            headers: headers,
            method: 'POST',
        }).then(response => response.json()).then(res => secretId = res.data.secret)
    }
}
function getcookiesessionid() {
    var cookieList=document.cookie.split(';');
    for(var i=0;i<cookieList.length;i++){
        if (cookieList[i].indexOf('sessionId')!=-1){
            csessionId=cookieList[i].split('=')[1];
            break;
        }
    }
